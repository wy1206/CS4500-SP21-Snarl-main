...
class AniKey(pygame.sprite.Sprite):
    """
    ...
    def __init__(self, pos_x, pos_y, width, height):
        ...
        super().__init__()
        self.sprites = []
        img1 = pygame.image.load(resource_path(r'Snarl/src/Game/resources/key/keys_1_1.png'))
        img2 = pygame.image.load(resource_path(r'Snarl/src/Game/resources/key/keys_1_2.png'))
        img3 = pygame.image.load(resource_path(r'Snarl/src/Game/resources/key/keys_1_3.png'))
        img4 = pygame.image.load(resource_path(r'Snarl/src/Game/resources/key/keys_1_4.png'))
